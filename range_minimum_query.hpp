...
namespace algo
{
    ...
    // @param [in]  left  - [recursive] left index of the current subrange
    // @param [in]  right - [recursive] right index of the current subrange
    // @param [in]  comp  - opional comparator, by default std::less
    // @return value      - index of min/max element of the subrange
    ...
    // @param [in]  end    - random iterator to the end of the input array
    // @param [in]  st     - segment tree
    // @param [in]  left   - left index of the RMQ
    // @param [in]  right  - right index of the RMQ
    // @param [in]  node   - [recursive] current node of the segment tree
    // @param [in]  leftx  - [recursive] left index of the current subrange
    // @param [in]  rightx - [recursive] right index of the current subrange
    // @param [in]  comp   - opional comparator, by default std::less
    // @return value       - index of min/max element of the subrange
